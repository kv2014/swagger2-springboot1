package com.kv.service.user.impl;
...
public class UserServiceImpl implements UserService {
    ...
    * */
    @Override
    public DataResult<User> findAllUser(int pageNum, int pageSize) {
        DataResult<User> result = new DataResult<>(true, "100", "成功", -1, null);
    ...
    public void insertMybatisBatch() {
        List<User> userDomains = new ArrayList<>(15);
        for (int i = 0; i < 10; i++) {
